...
const Owner_Profile = () => {
    ...
    return (
        <div className='min-h-screen bg-gray-50'>
            ...
            {
                err && (
                    <div className="bg-green-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mt-4 mx-4" role="alert">
                                            ...
                                            <>
                                                ...
                                                <form autoComplete="off" onSubmit={handleCreation} method="post" encType="multipart/form-data">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="grid grid-cols-2 gap-4">
                                                            <input name="stock" type="number" placeholder="Your Available Stock" className="border p-2 rounded w-full" onChange={handleChange} />
                                                            <input name="category" type="text" placeholder="Category of product" className="border p-2 rounded w-full" onChange={handleChange} />
                                                            <input name="brand" type="text" placeholder="Brand name" className="border p-2 rounded w-full" onChange={handleChange} />
                                                        </div>
                                                    </div>
                                                    <div>
